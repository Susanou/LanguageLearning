...
std::vector<float> Model::getFloats(json accessor)
{
	...
	unsigned int buffViewInd = accessor.value("bufferView", 1); //default value in case key DNE
	unsigned int count = accessor["count"]; //we know this always exist so can access as normal
