...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "Camera Window", NULL, NULL);
	...
	//Lighting step (generate a cube to represent the source)
	...
	glm::vec4 lightColor = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f); //white color
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		camera.Matrix(lightProgram, "camMatrix");
		// Bind the VAO so OpenGL knows to use it
		VAOlight.Bind();
		// Draw primitives, number of indices, datatype of indices, index of indices
