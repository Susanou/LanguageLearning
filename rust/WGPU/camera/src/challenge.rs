...
impl State {
    ...
    async fn new(window: &Window) -> Self {
        ...
        let challenge_texture = texture::Texture::from_bytes(&device, &queue, diffuse_bytes, "happy-tree-cartoon.png").unwrap();
    ...
    fn input(&mut self, event: &WindowEvent) -> bool {
        match event{
            WindowEvent::KeyboardInput { 
                ...
                self.use_challenge = *state == ElementState::Pressed;
                true
             }
             _ => false,
        }
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            if self.use_challenge {
                render_pass.set_bind_group(0, &self.challenge_bind_group, &[]);
            }
            else {
